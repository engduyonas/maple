...
export const metadata: Metadata = {
  title: "Our Leadership | Maple Leaf Foods",
};
  ...
  return (
    <>
      <HeroBanner
        ...
        backgroundImage="https://www.mapleleaffoods.com/media/4379/our-leadership-header-d.jpg"
      />
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            <section>
              ...
              <p className="text-mccain-gray-dark leading-relaxed mb-4">
                Founded by the Maple Leaf family, Maple Leaf Foods Limited remains a privately held company. We are led by our
                Global Management Team to deliver our purpose and mission in a way which fits the Maple Leaf values.
              </p>
              <p className="text-mccain-gray-dark leading-relaxed mb-4">
                While Maple Leaf Foods is a privately held company, our boards have adopted best practices for corporate
                governance. These types of practices ensure that Maple Leaf Foods has rigorous oversight of its management
            ...
            <section>
              <h2 className="text-2xl font-bold text-mccain-dark mb-4">
                The Maple Leaf Operating Company Board
              </h2>
            ...
            <section>
              ...
              <p className="text-mccain-gray-dark leading-relaxed mb-8">
                Our Maple Leaf Foods Senior Leadership Team plays a vital role in shaping our strategy, as well as
