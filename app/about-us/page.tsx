...
export const metadata: Metadata = {
  title: "Our Purpose & Values | Maple Leaf Foods",
};
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section>
              ...
              <p className="text-mccain-gray-dark leading-relaxed mb-8">
                Maple Leaf Foods is proud to be a family and values-driven company. Our values are integral to our culture,
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <ValueCard
                  ...
                  description="Maple Leaf is built on relationships and real connections. With each other, farmers, customers, communities and beyond. We take accountability for driving results and show resilience in any situation."
                />
                <ValueCard
                  title="Quality"
