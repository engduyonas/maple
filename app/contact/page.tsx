...
export const metadata: Metadata = {
  title: "Contact | Maple Leaf Foods",
};
  ...
  return (
    <>
      <HeroBanner
        ...
        backgroundImage="https://www.mapleleaffoods.com/media/4286/on-smart-phone-header-2.png"
      />
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="bg-white border rounded-lg p-6 shadow-sm">
                ...
                <p className="text-sm text-mccain-gray-dark mb-4">
                  If you have any questions about Maple Leaf Foods, please get in touch.
                </p>
                <Link
                  href="/contact"
              ...
              <div className="bg-white border rounded-lg p-6 shadow-sm">
                ...
                <p className="text-sm text-mccain-gray-dark mb-4">
                  Please contact us at media@mapleleaffoods.com
                </p>
                <Link
                  href="/contact"
                  className="inline-block bg-mccain-green hover:bg-mccain-green-dark text-white font-semibold px-5 py-2 rounded text-sm transition-colors"
              ...
              <div className="bg-white border rounded-lg p-6 shadow-sm">
                ...
                <p className="text-sm text-mccain-gray-dark mb-4">
                  Please check out our Careers pages for more information on jobs at Maple Leaf Foods.
                </p>
                <Link
              ...
              <div className="bg-white border rounded-lg p-6 shadow-sm">
                ...
                <p className="text-sm text-mccain-gray-dark mb-4">
                  Interested in applying for a role in Maple Leaf Foods? Start your search now!
                </p>
                <Link
                  href="https://www.mapleleaffoods.com/careers"
                  target="_blank"
