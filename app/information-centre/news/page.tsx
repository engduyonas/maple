...
export const metadata: Metadata = {
  title: "Latest News | Maple Leaf Foods",
};
...
export default function NewsPage() {
  return (
    <>
      <HeroBanner
        title="Latest News"
        backgroundImage="https://images.unsplash.com/photo-1495020689067-958852a7765e?auto=format&fit=crop&w=1800&q=80"
      />
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <SidePanel
            relatedLinks={[
              { label: "Maple Leaf on LinkedIn", href: "https://www.linkedin.com/company/maple-leaf-foods-inc" },
