    ...
    <div className="min-h-screen flex items-center justify-center bg-mccain-gray px-4">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center gap-3">
              <span className="w-10 h-10 rounded-full bg-mccain-green text-white font-bold text-sm flex items-center justify-center">
                MLF
              </span>
              <div>
                <p className="text-base font-bold text-mccain-dark leading-tight">Maple Leaf Foods</p>
                <p className="text-[10px] uppercase tracking-[0.2em] text-mccain-gray-dark">Admin Portal</p>
              </div>
            </div>
          </div>
        ...
        <p className="text-xs text-mccain-gray-dark text-center mt-6">
          &copy; {new Date().getFullYear()} Maple Leaf Foods Limited
        </p>
      </div>
    </div>
  );
